...
public class ZuoraController {
	...
	static String accountName = "ATG TEST";
	static String firstName = "Muhammad";
	static String lastName = "Ali";
	static String effectiveDate = "2018-09-19";
	//date to cancel the subscription
	static String cancelDate = "2019-11-30";
	//date to upgrade the subscription
	static String upgradeDate = "2019-12-01";
